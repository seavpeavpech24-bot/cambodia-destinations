...
@section('title', 'Add New Map Location')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 bg-gradient-to-r from-indigo-50 to-blue-50 p-6 rounded-xl shadow-sm mb-8">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Add New Map Location</h2>
            <p class="text-gray-600 mt-2 text-sm">Create a new location with coordinates and details</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.map-coordinators.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('latitude_and_longitude') }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Upload an image (max 2MB, jpeg, png, jpg, gif)</p>
                    @error('cover_url')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
