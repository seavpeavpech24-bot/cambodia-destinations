...
<div class="container mx-auto px-4 py-8 space-y-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 bg-gradient-to-r from-indigo-50 to-blue-50 p-6 rounded-xl shadow-sm">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Add YouTube Video</h2>
            <p class="text-gray-600 mt-2 text-sm">Add a new YouTube video</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.youtube-videos.store') }}">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="video_id" id="video_id" value="{{ old('video_id') }}" placeholder="e.g., dQw4w9WgXcQ" class="mt-1 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-200" required>
